...
class Joueur(models.Model):
    ...
    shotCounter = models.IntegerField(default=0)
    stabCounter = models.IntegerField(default=0)
    ...
    dialogCounter = models.IntegerField(default=0)
    interactionCounter = models.IntegerField(default=0)
    phoneCallCounter = models.IntegerField(default=0)
    tradeCounter = models.IntegerField(default=0)
    lootCounter = models.IntegerField(default=0)
    ...
    freezeTime = models.IntegerField(default=0)
